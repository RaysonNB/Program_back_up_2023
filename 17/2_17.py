...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
            ...
            if len(poses) > 0:
                ...
                if poses[0][9][2] > 0 and poses[0][7][2] > 0:
                    ...
                    if (640 >= B[0] >= 0 and 320 >= B[1] >= 0):
                        ...
                        yu += 1
            print(A, B)
            if len(A) != 0 and yu >= 2 and az <= 1200:
                cv2.circle(outframe, (A[0], A[1]), 3, (0, 255, 0), -1)
            if len(B) != 0 and yu >= 2 and bz <= 1200:
        ...
        if getframeyyy == "object":
            ...
            roll, pitch, yaw1 = euler_from_quaternion(q)
            # break
