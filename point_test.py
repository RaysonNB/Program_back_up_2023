...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        if getframeyyy=="object":
            axs1, ays1, axs2, ays2 = test_point(ax, ay, degree666)
            bxs1, bys1, bxs2, bys2 = test_point(bx, by, degree666)
            ...
            for i, detection in enumerate(bb):
                ...
                dis_list.append(pz)
                cnt = get_distance(px, py, pz, axs1, ays1, az, bxs1, bys1, bz)
